...
names = ["Leandro Barbosa", "Ian Clark", "Draymond Green", "Kevon Looney", "Marreese Speights", "Harrison Barnes", "Stephen Curry", "Andre Iguodala", "James Michael McAdoo", "Klay Thompson", "Andrew Bogut", "Festus Ezeli", "Shaun Livingston", "Brandon Rush", "Anderson Varejao", "Justin Holiday", "David Lee", "Ognjen Kuzmic", "Hilton Armstrong", "Kent Bazemore"]
